          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-sm">Rua Adhemar da Silva, 1070,<br/>Campinas, São José - SC</span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 mr-2 text-amber-500 shrink-0" />
                <span className="text-sm">(48) 3241-1184</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 mr-2 text-amber-500 shrink-0" />
                <span className="text-sm">secretaria@ieclbcampinas.com.br</span>
              </li>
            </ul>
          </div>
