  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative bg-blue-900 text-white py-20 lg:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('https://picsum.photos/id/1047/1920/1080')] bg-cover bg-center mix-blend-overlay opacity-30 z-0"></div>

        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="inline-block py-1 px-3 rounded-full bg-blue-800/50 border border-blue-400 text-blue-200 text-sm font-semibold mb-6 tracking-wide">
            IECLB São José
          </span>
          ...
          <p className="mt-6 max-w-2xl mx-auto text-lg md:text-xl text-blue-100 leading-relaxed">
